...
bool ModuleSceneIntro::Start()
{
	...
	sog.CreateRectangle({ -15.00, -0.50 + 10, -30.00 }, { 0.00, 0.10, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ 15.00, 1.00 + 10, -30.00 }, { 0.00, 0.00, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ 20.00, 2.50 + 10, -55.00 }, { 0.10, 0.00, 0.00 }, { 20.00, 30.00, 0.50 });
	sog.CreateRectangle({ 20.00, 4.00 + 10, -80.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });


	sog.CreateRectangle({ -5.00, 5.50 + 10, -80.00 }, { 0.00, -0.10, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ -30.00, 7.00 + 10, -80.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });
	sog.CreateRectangle({ -80.00, 3.00 + 10, -80.00 }, { 0.00, 0.10, 0.00 }, { 80.00, 20.00, 0.50 });


	sog.CreateRectangle({ -135.00, -1.00 + 10, -80.00 }, { 0.00, 0.00, 0.00 }, { 30.00, 10.00, 0.50 });


	sog.CreateRectangle({ -145.00, -1.00 + 10, -105.00 }, { 0.00, 0.00, 0.00 }, { 10.00, 40.00, 0.50 });
	sog.CreateRectangle({ -145.00, -1.00 + 10, -135.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });
	sog.CreateRectangle({ -110.00, 1.50 + 10, -135.00 }, { 0.00, 0.10, 0.00 }, { 50.00, 10.00, 0.50 });


	sog.CreateRectangle({ -45.00, 4.00 + 10, -135.00 }, { 0.00, 0.00, 0.00 }, { 80.00, 20.00, 0.50 });
	...
	//FONDO---------------------
	sog.CreateRectangle({ 0.00, -20, 0.00 }, { 0.00, 0.00, 0.00 }, { 1000.00, 1500.00, 5.00 }, Green); // Suelo
	sog.CreateRectangle({ 0.00, 200, 0.00 }, { 0.00, 0.00, 0.00 }, { 1000.00, 1000.00, 5.00 }, Blue); //Cielo
	sog.CreateRectangle({ 0.00, 0.00, 200.00 }, { 0.00, 0.00, 0.00 }, { 1000.00, 5.00, 1000.00 }, Blue); 
	sog.CreateRectangle({ 0.00, 0.00, -200.00 }, { 0.00, 0.00, 0.00 }, { 1000.00, 5.00, 1000.00 }, Blue); 
	sog.CreateRectangle({ 200.00, 50.00, 0.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 1000.00, 1000.00 }, Blue); 
	sog.CreateRectangle({ -200.00, 50.00, 0.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 1000.00, 1000.00 }, Blue); 
	...
	checkpoints.add(sog.CreateRectangle({ -40,9,20 }, { 0,0,0 }, { 20,5,10 }, Red, 0, true));
	checkpoints.add(sog.CreateRectangle({ 20,16,-43 }, { 0,0,0 }, { 20,5,10 }, Red, 0, true));
	checkpoints.add(sog.CreateRectangle({ -90,16,-80 }, { 0,0,30 }, { 20,5,10 }, Red, 0, true));
	checkpoints.add(sog.CreateRectangle({ -145,12,-125 }, { 0,0,0 }, { 20,5,10 }, Red, 0, true));
