...
bool ModuleSceneIntro::Start()
{
	...
	sog.CreateRectangle({ 0.00, -5.00, 0.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 80.00, 0.50 });
	sog.CreateRectangle({ -20.00, -5.00, 50.00 }, { 0.00, 0.00, 0.00 }, { 60.00, 20.00, 0.50 });
	sog.CreateRectangle({ -40.00, -3.50, 25.00 }, { 0.10, 0.00, 0.00 }, { 20.00, 30.00, 0.50 });
	sog.CreateRectangle({ -40.00, -2.00, -15.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 50.00, 0.50 });
	sog.CreateRectangle({ -15.00, -0.50, -30.00 }, { 0.00, 0.10, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ 15.00, 1.00, -30.00 }, { 0.00, 0.00, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ 20.00, 2.50, -55.00 }, { 0.10, 0.00, 0.00 }, { 20.00, 30.00, 0.50 });
	sog.CreateRectangle({ 20.00, 4.00, -80.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });


	sog.CreateRectangle({ -5.00, 5.50, -80.00 }, { 0.00, -0.10, 0.00 }, { 30.00, 20.00, 0.50 });
	sog.CreateRectangle({ -30.00, 7.00, -80.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });
	sog.CreateRectangle({ -80.00, 3.00, -80.00 }, { 0.00, 0.10, 0.00 }, { 80.00, 20.00, 0.50 });


	sog.CreateRectangle({ -135.00, -1.00, -80.00 }, { 0.00, 0.00, 0.00 }, { 30.00, 10.00, 0.50 });


	sog.CreateRectangle({ -145.00, -1.00, -105.00 }, { 0.00, 0.00, 0.00 }, { 10.00, 40.00, 0.50 });
	sog.CreateRectangle({ -145.00, -1.00, -135.00 }, { 0.00, 0.00, 0.00 }, { 20.00, 20.00, 0.50 });
	sog.CreateRectangle({ -110.00, 2.00, -135.00 }, { 0.00, 0.10, 0.00 }, { 50.00, 10.00, 0.50 });


	sog.CreateRectangle({ -45.00, 5.00, -135.00 }, { 0.00, 0.00, 0.00 }, { 80.00, 20.00, 0.50 });

	//OBSTACULOS---------------
	sog.CreateRectangle({ -50.00, 6.00, -140.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 5.00, 2.00 });
	sog.CreateRectangle({ -60.00, 6.00, -130.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 5.00, 2.00 });
	sog.CreateRectangle({ -70.00, 6.00, -130.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 5.00, 2.00 });
	sog.CreateRectangle({ -80.00, 6.00, -135.00 }, { 0.00, 0.00, 0.00 }, { 5.00, 5.00, 2.00 });
